...
<%
/* Variabele für die Serverantwort Attrubut("username") 
...
/* Variabele für die Serverantwort Attrubut("password") 
Nimmt den vom Server gesendeten username an ( Bei falsch Eingaben wird diese JSP erneut geladen)
Damit der User seine fehleingaben korrigieren kann sollen diese wieder in die eingabefelder geladen werden*/
String password = (String)request.getAttribute("password"); 
/*Variabele für den Http Statuscode der Serverantwort ( 200 ok, 404 not found ...)*/
int statuscode = response.getStatus(); 
%>
<%!
/* Mathode zum schreiben des input Values für den username*/
public String usernamePlaceholder(String username){
	// Gab es noch keine Server Antwort
	if(username == null){
		/*sorgt dafür das das html attribut placeholder des input Aktiv bleibt.
	...
	// ansonsten gieb die alte eingabe als Text an ( ermöglich korrektur )
	return username;
}
%>
...
public String passwordPlaceholder(String password){
	...
	// ansonsten gib das alte passwort zurück und ermöglich korrektur 
	return password;
}
%>
    ...
    <div class="container">
        ...
        <form action="./loginCheck" method="post" NAME="form1">
            ...
            <div class="row">
                ...
                <div class="col-xs-5 col-sm-2 col-md-2 col-lg-1 form-group">
                    <center>
                        <!-- Link zur Registrierenseite einfügen als hrref="../Reg" -->
