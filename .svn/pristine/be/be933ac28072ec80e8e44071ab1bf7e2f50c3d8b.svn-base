...
<body data-ng-controller="MyController">
	...
	public String welcomeText(String username) {
		if (username != null) {
			return "Wilkomen " + username + "<br><small>wählen Sie ein Spiel</small>";
		}
		return "Wilkomen <br><small>wählen Sie ein Spiel</small>";
	}%>
			...
			<FORM NAME="form1" METHOD="POST" action="./loginCheck">
				<ol class="breadcrumb">
					...
					<!-- Die versteckten <Input> Tages,
       				 senden dem LoginCheck.servlet die benötigten requestParameter.
       				 a) logoutflag wird benötigt damit das servlet die Nutzer Sitzung schließt
       				 b) username wird benötigt damit das servlet dieser jsp den usernamen zurücksenden kann 
       				 c) mode wird benötigt um Spiel beizutreten oder zu erstellen-->
