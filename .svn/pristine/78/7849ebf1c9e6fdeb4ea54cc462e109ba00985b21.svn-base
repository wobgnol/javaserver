...
* 				 benötigten Funktionen für die Playsheet Verwaltung		*
* 				 zur Verfügung											*
* 																		*
*************************************************************************
*/
...
//	private long id;
	...
	/*Ein zusammengesetzter Primärschlüssel, welcher durch eine Klasse
	 * repräsentiert wird*/
	@EmbeddedId
...
//	}
	/*
	 * Diese Funktion fragt gegen die Datenbank, welches die nächste Freie Playsheet id ist.
	 * Diese wird durch die Menge der vorhandenen Playsheets festgelegt.
	 * Die Abfrage wird nur ausgeführt, falls die ID nocht nicht bekannt ist*/
	...
	/*
	 * Diese Funktion setzt alle Werte, welche "gesetzt" werden können, sobald
