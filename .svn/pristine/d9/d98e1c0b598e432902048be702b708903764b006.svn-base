...
public class BeerGameFactory {
	...
	// Factory Methoden für die Klasse: 	Game_V1_01		-----------------Start 
	/**
	 * Erstellt eine Inztanz der Klasse Game_V1_01 mit standart Konstrucktor
	 * @return Giebt eine Inztanz der Klasse Game_V1_01 zurück.
	 */
	 ...
	 * @return Giebt eine Inztanz der Klasse Game_V1_01 mit bereits beschriebenen Attribut: List<User_V1_01> playerlist zurück
	 */
	...
	// Factory Methoden für die Klasse: 	Game_V1_01		-----------------Ende 
	
	
	
	// Factory Methoden für die Klasse: 	User_V1_01		-----------------Start 
	/**
	 * Erstellt eine Inztanz der Klasse User_V1_01 mit standart Konstrucktor
	 * @return Giebt eine Inztanz der Klasse User_V1_01 zurück.
	 */
	 ...
	 * @return Giebt eine Inztanz der Klasse User_V1_01 mit beschreibenen Attrubuten: username und password zurück.
	 */
	...
	// Factory Methoden für die Klasse: 	User_V1_01		-----------------Ende 
	
	
	// Factory Methoden für die Klasse: 	Playsheet_V1_01		-----------------Start 
	/**
	 * Erstellt eine Inztanz der Klasse Playsheet_V1_01 mit standart Konstrucktor
	 * @return Giebt eine Inztanz der Klasse Playsheet_V1_01 zurück:
	 */
	 ...
	 * @return Giebt eine Inztanz der Klasse Playsheet_V1_01 im initialisierten Zustand zurück:
	 * 
	 * 			owner = ownerID;
	 *			gameid = gameID;
	 *			inventory = 5; 	
	...
	// Factory Methoden für die Klasse: 	Playsheet_V1_01		-----------------Ende 
